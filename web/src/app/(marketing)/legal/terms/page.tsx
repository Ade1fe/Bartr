    ...
    <div className="min-h-screen bg-white w-full">
      ...
      <div className="max-w-360 mx-auto px-4 lg:px-8 py-4 flex gap-16">
        ...
        <main className="flex-1 min-w-0 w-full">
          ...
          {/* Breadcrumb */}
          <div className="border-b border-neutral-100 px-6 py-3 mb-3">
            <p className="text-sm text-neutral-400">
              Home &rsaquo; Legal &rsaquo;{' '}
          ...
          <div className="bg-[#86B7A9]/10 border border-[#86B7A9]/20 rounded-xl p-3 mb-12 flex gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-[#86B7A9] mb-1">In plain English</p>
          ...
          <Section id="user-listings" number={4} title="User Listings and Content">
            ...
            <p className="mt-4 text-sm text-neutral-600">By posting content, you confirm that:</p>
            <ol className="mt-3 space-y-2 list-none">
              {[
          ...
          <Section id="trade-process" number={5} title="The Trade Process">
            ...
            <p className="mt-4 text-sm text-neutral-600">The trade process on Bartr works as follows:</p>
            <ol className="mt-3 space-y-2 list-none">
              {[
          ...
          <Section id="credit-system" number={6} title="Credit System">
            ...
            <ul className="mt-3 space-y-2 list-disc list-inside disc pl-5 marker:text-neutral-400 marker:text-xs">
              {[
                ...
                <li key={i} className="gap-3 text-sm text-neutral-600">
                  {/* <span className="text-neutral-400 shrink-0">
                    ({String.fromCharCode(97 + i)})
                  </span> */}
                  {item}
          ...
          <Section id="ip" number={11} title="Intellectual Property">
            <p className="text-sm text-neutral-600">All platform content, design, code, trademarks, and branding are owned by Bartr and protected by applicable intellectual property laws.</p>
            <p className="text-sm text-neutral-600">By posting content on Bartr, you grant us a <strong>non-exclusive, royalty-free, worldwide licence</strong> to display, reproduce, and distribute that content solely for the purpose of operating the platform. You retain ownership of all content you post.</p>
          </Section>
          <Section id="changes" number={12} title="Changes to These Terms">
            <p className="text-sm text-neutral-600">We will notify users of material changes to these Terms via email and in-app notification at least <strong>14 days</strong> before they take effect. Continued use of the platform after changes take effect constitutes acceptance.</p>
          </Section>
          <Section id="governing-law" number={13} title="Governing Law">
            <p className="text-sm text-neutral-600">These Terms are governed by the laws of the <strong>Federal Republic of Nigeria.</strong> Any disputes arising from these Terms shall be subject to the jurisdiction of the courts of Nigeria, without prejudice to your rights under consumer protection laws in your country of residence.</p>
          </Section>
          ...
          <section className='scroll-mt-24'>
            ...
            <div className='mt-3 flex flex-col gap-3'>
              ...
              <div className='flex gap-4'>
                <a href='/legal/privacy' className='font-light text-sm text-neutral-400 flex gap-1 cursor-pointer items-center'><FileText className='size-4' /> Privacy Policy</a>
                <a href='/legal/dispute-resolution' className='font-light text-sm text-neutral-400 flex gap-1 cursor-pointer items-center'><FileText className='size-4' /> Dispute Resolution Policy</a>
                <a href='/guidelines' className='font-light text-sm text-neutral-400 flex gap-1 cursor-pointer items-center'><FileText className='size-4' /> Community Guidelines</a>
              </div>
            </div>
          </section>
        </main>
